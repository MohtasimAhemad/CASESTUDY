...
export class ProductService {
  ...
  searchProductByBrand(brand: string): Observable<Product[]> {
    return this.http
      .get<Product[]>(`http://localhost:8080/product/getproductbybrand/${brand}`)
      .pipe(catchError(this.handleError<Product[]>('searchProductByBrand', [])));
  }
